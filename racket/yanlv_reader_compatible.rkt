    ...
    (for/list ([line-tokens all-tokens]
      ...
      (cond
        ...
        [(find-token-index line-tokens "定义变量")
         (define var-pos (find-token-index line-tokens "定义变量"))
         (define value-pos (find-token-index line-tokens "为"))
         (and var-pos value-pos)
         (define var-name (token-value (list-ref line-tokens (+ var-pos 1))))
